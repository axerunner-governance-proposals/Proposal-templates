###### Usage & Content
* Follow this [proposal guide](https://github.com/axerunner-governance-proposals/guides/blob/master/Create_a_Proposal_Using_a_Template.md) to use this template
...
###### Description
Summarize the proposal in narrative form, anywhere from a few sentences to a few paragraphs.
Provide background and context related to the need and motivation for your project.  
...
Now that you know your total schedule and budget, you can divide the cost accordingly.  If the total time required is 2 months and the total budget requested is 100 AXE, schedule your payment terms as **50 AXE per month** for **2 months**
